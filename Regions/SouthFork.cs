namespace F3Core.Regions
{
    public class SouthFork : Region
    {
        ...
        public override List<int> MasterDataSheetIds => new List<int> { 49879406, 729344821 };
        public override List<string> MasterDataSheetNames => new List<string> { "Master Data 21-22", "Master Data" };
        ...
        {
            RosterSheetColumn.Formula, RosterSheetColumn.PaxName, RosterSheetColumn.JoinDate, RosterSheetColumn.Empty, RosterSheetColumn.NamingRegionName, RosterSheetColumn.EhBy
        };
