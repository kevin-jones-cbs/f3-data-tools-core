...
{
    public class Redlands : Region
    {
        public override string QueryStringValue => "redlands";
        public override string DisplayName => "Redlands";

        public override string SpreadsheetId => "1gs9Q9I18shVLwOdONg3lj06FcHthUYTwYYtRA9zghos";
